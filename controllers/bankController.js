...
module.exports.pull = async (req, res) => {
	...
	try {
		...
		const response = await queryChaincode.queryChaincode(['peer0'], config.get('channelName'), chaincodeName, 'bankPullOpen4bankOffers', [JSON.stringify({})], org_name, 'admin', 'adminpw')
